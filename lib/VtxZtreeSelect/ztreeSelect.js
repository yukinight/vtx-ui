...
var SelectZTree = function (_React$Component) {
    ...
    _createClass(SelectZTree, [{
        ...
        value: function render() {
            ...
            }, _defineProperty(_treeProps, treeCheckable ? 'checkedKeys' : 'selectedKeys', value_arr), _defineProperty(_treeProps, 'defaultExpandAll', treeDefaultExpandAll), _defineProperty(_treeProps, 'expandedKeys', expandedKeys), _defineProperty(_treeProps, 'refreshFlag', t.treeRefreshFlag), _defineProperty(_treeProps, 'ref', function ref(instance) {
