...
var SelectZTree = function (_React$Component) {
    ...
    _createClass(SelectZTree, [{
        ...
        value: function getKeyNodesMapping() {
            var t = this;
            t.keyNodesMapping = {};
        ...
        value: function render() {
            ...
            var name_arr = value_arr.filter(function (k) {
                return k in t.keyNodesMapping;
            }).map(function (item) {
                return t.keyNodesMapping[item].name;
            });
            // ztree配置
            var treeProps = (_treeProps = {
            ...
            }, _defineProperty(_treeProps, treeCheckable ? 'checkedKeys' : 'selectedKeys', value_arr), _defineProperty(_treeProps, 'defaultExpandAll', treeDefaultExpandAll), _defineProperty(_treeProps, 'ref', function ref(instance) {
                ...
                console.log({ checkedNodes: checkedNodes, checkedKeys: checkedKeys, checkedNames: checkedNames });
                if (treeCheckable) {
                    t.props.onChange && t.props.onChange({
                        nodes: checkedNodes,
                        keys: checkedKeys,
            ...
            var popoverProps = _extends({}, this.props, {
                ...
                name_arr.length > 0 ? [name_arr.map(function (item, index) {
                    return _react2.default.createElement(
                        _tag2.default,
                        { key: item, closable: !disabled,
            ...
            var SingleSelect = _react2.default.createElement(_input2.default, { ref: function ref(t) {
                ...
                suffix: disabled || value_arr.length == 0 ? null : _react2.default.createElement(_icon2.default, { type: 'close-circle', onClick: t.clear.bind(t), style: { cursor: 'pointer' } })
            });
