...
var VortexDatagrid = function (_React$Component) {
    ...
    function VortexDatagrid(props) {
        ...
        _this.state = {
            ...
            columnsVisibility: props.columns.map(function (item) {
                return { title: item.title, visible: true };
            })
        };
    ...
    _createClass(VortexDatagrid, [{
                    ...
                    if (typeof newCol.render == 'function') {
                        ...
                        newCol.render = function (text, record) {
                            ...
                            return _react2.default.createElement(
                                _tooltip2.default,
                                { title: text.toString(), placement: 'topLeft' },
        ...
        value: function changeColumnVisibility(title, visible) {
            this.setState({
        ...
        key: 'generateButtons',
        value: function generateButtons(btList, rowData) {
            return _react2.default.createElement(
                'span',
                null,
                btList.map(function (bt, bt_index) {
                    switch (bt.name) {
                        /*case '编辑': return (
                            <span key={bt_index}>
