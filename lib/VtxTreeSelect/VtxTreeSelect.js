...
var VtxTreeSelect = function (_React$Component) {
    ...
    _createClass(VtxTreeSelect, [{
        ...
        value: function onChange(value, label, extra) {
            ...
            if ('onChange' in t.props && typeof t.props.onChange === 'function') {
                if (t.props.treeCheckable) {
                    ...
                    t.props.onChange({ allValue: value, allLabel: label, value: v, label: l, treeNodes: treeNodes });
                } else {
                    t.props.onChange({ allValue: value, allLabel: label, value: value, label: label, treeNodes: treeNodes });
                }
            }
            this.setState({
                value: v || []
        ...
        value: function render() {
            ...
            var TreeSelectProps = _extends({}, treeSelect, {
                ...
                getPopupContainer: function getPopupContainer() {
                    return document.getElementById(_this3.id);
                }
                //动态加载树数据
        ...
        value: function componentWillReceiveProps(nextProps) {
            //已加载组件，收到新的参数时调用
            var t = this;
            if (!_immutable2.default.is(_immutable2.default.fromJS(t.props.data), _immutable2.default.fromJS(nextProps.data))) {
                t.setState({
