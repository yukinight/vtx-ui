    ...
    _createClass(VtxExport, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('iframe', { name: 'export_iframe', style: { display: 'none' },
                    ref: function ref(ifm) {
                        if (ifm) _this2.iframe = ifm;
                    },
                    onLoad: function onLoad() {
                        if (typeof _this2.props.afterUpload == 'function') {
                            _this2.props.afterUpload();
                        }
                    } })
            );
        }
