    ...
    _createClass(VtxRpsFrame, [{
        ...
        value: function getReportInfoByCode() {
            ...
            var _props = this.props,
                ...
                _props$getTypeCodeUrl = _props.getTypeCodeUrl,
                getTypeCodeUrl = _props$getTypeCodeUrl === undefined ? '/cloud/management/rest/np/param/getByParamTypeCode' : _props$getTypeCodeUrl,
                _props$getReportCodeU = _props.getReportCodeUrl,
                getReportCodeUrl = _props$getReportCodeU === undefined ? '/cloud/rps/api/np/v101/report/getReportInfoByCode.smvc' : _props$getReportCodeU,
                _props$ReportServerUr = _props.ReportServerUrl,
                ReportServerUrl = _props$ReportServerUr === undefined ? '/ReportServer' : _props$ReportServerUr;
            ...
            Promise.all([commonParamPromise, getReportInfoByCodePromise]).then(function (data) {
                ...
                if (!commonParamResult.result && !reportInfoByCodeResult.result) {
                    ...
                    createForm(ReportServerUrl + '?report_code=' + report_code + '&reportlet=' + reportInfoByCodeData.reportlet + '&fr_locale=zh_CN&timestamp=' + new Date().valueOf(), _param, '' + t.iframeName);
                }
            }).catch(function (err) {
