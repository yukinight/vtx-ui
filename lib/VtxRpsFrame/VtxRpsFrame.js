...
var _VtxRpsFrame = require('./VtxRpsFrame.css');

var _VtxRpsFrame2 = _interopRequireDefault(_VtxRpsFrame);
...
var VtxRpsFrame = function (_React$Component) {
    ...
    function VtxRpsFrame() {
        ...
        return _possibleConstructorReturn(this, (VtxRpsFrame.__proto__ || Object.getPrototypeOf(VtxRpsFrame)).call(this));
    }
    ...
    _createClass(VtxRpsFrame, [{
        ...
        value: function getReportInfoByCode() {
            ...
            Promise.all([commonParamPromise, getReportInfoByCodePromise]).then(function (data) {
                ...
                if (!commonParamResult.result && !reportInfoByCodeResult.result) {
                    ...
                    createForm('/ReportServer?report_code=' + report_code + '&reportlet=' + reportInfoByCodeData.reportlet + '&fr_locale=zh_CN&timestamp=' + new Date().valueOf(), _param, 'yy');
                }
            }).catch(function (err) {
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: _VtxRpsFrame2.default.iframeParent },
                _react2.default.createElement('iframe', { className: _VtxRpsFrame2.default.iframe + ' wrapper', width: '100%', height: '100%', name: 'yy' })
            );
        }
    }]);
