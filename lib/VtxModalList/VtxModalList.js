...
var VtxModalList = function (_React$Component) {
    ...
    _createClass(VtxModalList, [{
        ...
        value: function cloneComponent(elem, index) {
            ...
            var e = _react2.default.cloneElement(elem, _extends({}, elem.props, {
            ...
            }, isInherit() ? { inherit: true } : {}, typeof elem.type == 'function' && elem.type.name.toLocaleLowerCase().indexOf('input') ? { onBlur: function onBlur(e) {
                ...
                } } : {}, typeof elem.type == 'function' && elem.type.name.toLocaleLowerCase().indexOf('input') > -1 && 'onChange' in elem.props && typeof elem.props.onChange == 'function' ? { onChange: function onChange(e) {
            ...
            t.repeteList[index] = _extends({
                isRepete: false }, t.repeteList[index] || {}, reg, {
                mld: mld,
                type: ty,
                elem: e
            });

            var _t$verify = t.verify(reg.value, mld, index),
