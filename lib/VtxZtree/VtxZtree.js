...
var VtxZtree = function (_React$Component) {
    ...
    function VtxZtree(props) {
        ...
        _this.treeId = 'tree-' + new Date().getTime() + '-' + parseInt(Math.random() * 1000);
        _this.zTreeObj = null;
        _this.treeSetting = {};
        _this.treeNodes = [];
    ...
    _createClass(VtxZtree, [{
        ...
        value: function getCheckedNodes() {
            return this.zTreeObj.getCheckedNodes(true).map(function (item) {
                return _extends({}, item, {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.isShowSearchInput ? _react2.default.createElement(
                    ...
                    _react2.default.createElement(_input2.default, { value: t.state.searchVal, onChange: function onChange(e) {
                            var newSearch = e.target.value.trim();
