...
var BMap = function (_React$Component) {
    _inherits(BMap, _React$Component);

    function BMap(props) {
        _classCallCheck(this, BMap);

        var _this = _possibleConstructorReturn(this, (BMap.__proto__ || Object.getPrototypeOf(BMap)).call(this, props));
    ...
    _createClass(BMap, [{
                ...
                if (window.BMap) {
                    ...
                    $.getScript('http://api.map.baidu.com/getscript?v=2.0&ak=EVlFc6DZzAzU5avIjoxNcFgQ', function () {
                        var DistanceTool = new Promise(function (resolve, reject) {
                            $.getScript('./resources/js/mapPlugin/DistanceTool_min.js', function () {
                                resolve();
                            });
                        });
                        var TrafficControl = new Promise(function (resolve, reject) {
                            $.getScript('./resources/js/mapPlugin/TrafficControl_min.js', function () {
                                resolve();
                            });
                        });
                        var MarkerClusterer = new Promise(function (resolve, reject) {
                            $.getScript('./resources/js/mapPlugin/MarkerClusterer_min.js', function () {
                                resolve();
                            });
                        });
                        var AreaRestriction = new Promise(function (resolve, reject) {
                            $.getScript('./resources/js/mapPlugin/AreaRestriction_min.js', function () {
                                resolve();
                            });
                        });
                        var DrawingManager = new Promise(function (resolve, reject) {
                            $.getScript('./resources/js/mapPlugin/DrawingManager_min.js', function () {
                                resolve();
                            });
                        });
                        var Heatmap = new Promise(function (resolve, reject) {
                            $.getScript('./resources/js/mapPlugin/Heatmap_min.js', function () {
                                resolve();
                            });
                        });
                        var GeoUtils = new Promise(function (resolve, reject) {
                            $.getScript('./resources/js/mapPlugin/GeoUtils_min.js', function () {
                                resolve();
                            });
                        });
                        var TextIconOverlay = new Promise(function (resolve, reject) {
                            $.getScript('./resources/js/mapPlugin/TextIconOverlay_min.js', function () {
                                resolve();
                            });
                        });
        ...
        key: 'addPoint',
        value: function addPoint(mapPoints) {
            var _this2 = this;
            ...
            mapPoints.map(function (item, index) {
                ...
                if (item.markerContent) {
                    ...
                    var icon = new BMap.Icon('./resources/images/touming.png', new BMap.Size(cg.width, cg.height));
                    ...
                    var _icon = new BMap.Icon(item.url || './resources/images/defaultMarker.png', new BMap.Size(cg.width, cg.height));
        ...
        value: function updatePoint(mapPoints) {
            ...
            mapPoints.map(function (item, index) {
                ...
                if (_this3.GM.isRepetition(item.id)) {
                    ...
                    if (item.markerContent) {
                        ...
                        //未改变方式的点 直接修改数据
                        var _icon2 = new BMap.Icon(item.url || './resources/images/defaultMarker.png', new BMap.Size(cg.width, cg.height));
            ...
            //删除改变了加载方式的点
            dpoints.map(function (item, index) {
        ...
        key: 'addLine',
        value: function addLine(mapLines) {
            var t = this;
        ...
        */
        ...
        value: function draw(obj) {
            ...
            switch (obj.geometryType) {
                case 'point':
                    param.offset = new BMap.Size((obj.parameter.markerContentX || -15) + (obj.parameter.width || 30) / 2, (obj.parameter.markerContentY || -30) + (obj.parameter.height || 30) / 2);
                    var icon = new BMap.Icon(obj.parameter.url || './resources/images/defaultMarker.png', new BMap.Size(obj.parameter.width || 30, obj.parameter.height || 30));
        ...
        value: function moveTo(id, lnglat, delay, autoRotation) {
            ...
            if (s.equals(e)) {
                ...
                t.moveToTimer[id] = setInterval(function () {
                    if (!gc) {
                        clearInterval(t.moveToTimer[id]);
                    } else {
                        ct += 1;
