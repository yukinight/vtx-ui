                ...
                switch (services[im].type) {
                    ...
                    case 'wmts':
                        for (var _i = 0; _i < url.length; _i++) {
                            ...
                            wmtsLayer.UrlTemplate = wmtsLayer.UrlTemplate.replace(wmtsLayer.UrlTemplate.substring(wmtsLayer.UrlTemplate.indexOf('&FORMAT'), wmtsLayer.UrlTemplate.indexOf('&TILEMATRIXSET')), '&FORMAT=' + services[im].format);
            ...
            if (services.length <= 0) {
                ...
                for (var _im = 0; _im < _MapToolFunction.defaultWmtsMapLayers.services.length; _im++) {
                    ...
                    for (var _i2 = 0; _i2 < _url.length; _i2++) {
                        ...
                        _wmtsLayer.UrlTemplate = _wmtsLayer.UrlTemplate.replace(_wmtsLayer.UrlTemplate.substr(_wmtsLayer.UrlTemplate.indexOf('&FORMAT='), _wmtsLayer.UrlTemplate.substr(_wmtsLayer.UrlTemplate.indexOf('&FORMAT=') + 1).indexOf('&') + 1), '&FORMAT=' + _MapToolFunction.defaultWmtsMapLayers.services[_im].format);
        ...
        */
        ...
        value: function draw(obj) {
            ...
            if (drawParam.geometryType !== 'point') {
                ...
                //点的样式
                var markerSymbol = new esri.symbol.PictureMarkerSymbol(drawParam.parameter.url || './resources/images/defaultMarker.png', drawParam.parameter.width || 30, drawParam.parameter.height || 30);
                //设置点偏移
