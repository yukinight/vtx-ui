    ...
    _createClass(ArcgisMap, [{
            ...
            var event = function event() {
                ...
                var rangingToolFun = function rangingToolFun(e, status) {
                    if (t.rangingTool.isRanging) {
                        ...
                        if (t.rangingTool.points.length > 0) {
                            t.rangingTool.distance += (0, _MapToolFunction.getDistance)(lnlt, [t.rangingTool.points[t.rangingTool.points.length - 1].longitude, t.rangingTool.points[t.rangingTool.points.length - 1].latitude], t.state.gis, t.state.wkid);
                        } else {
                ...
                t.state.gis.on('mouse-move', function (e) {
                    ...
                    if (t.rangingTool.isRanging) {
                        ...
                        if (t.rangingTool.points.length > 0) {
                            var distance = (0, _MapToolFunction.getDistance)([e.mapPoint.x, e.mapPoint.y], [t.rangingTool.points[t.rangingTool.points.length - 1].longitude, t.rangingTool.points[t.rangingTool.points.length - 1].latitude], t.state.gis, t.state.wkid);
                            // 实时计算距离
                            distance += t.rangingTool.distance;
        ...
        */
            ...
            if (!t.drawToolbar) {
                ...
                t.drawToolbar.on('draw-complete', function (e) {
                    ...
                    if (t.drawParam.geometryType == 'circle') {
                        var radius = (0, _MapToolFunction.getDistance)([e.geometry._extent.xmin, e.geometry._extent.ymin], [e.geometry._extent.xmax, e.geometry._extent.ymax], t.state.gis, t.state.wkid) / 2;
        ...
        value: function calculatePointsDistance(fp, ep) {
            return (0, _MapToolFunction.getDistance)(fp, ep, this.state.gis, this.state.wkid);
        }
        //计算多个点的距离(常用于线计算)
