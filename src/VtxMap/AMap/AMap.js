        ...
        this.loadMapComplete = new Promise((resolve,reject)=>{
            if(window.AMap){
                ...
                $.getScript(`${configUrl.mapServerURL}/A_content.js`,()=>{
                    $.getScript('//webapi.amap.com/maps?v=1.4.14&key=e59ef9272e3788ac59d9a22f0f8cf9fe&plugin=AMap.Geolocation,AMap.MarkerClusterer,AMap.Scale,AMap.ToolBar,AMap.DistrictSearch,AMap.RangingTool,AMap.MouseTool,AMap.PolyEditor,AMap.CircleEditor,AMap.PlaceSearch,AMap.Heatmap',()=>{
